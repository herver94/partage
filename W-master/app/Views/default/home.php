...
<?php $this->start('contenu') ?>
    ...
    <div class="row headline"><!-- Begin Headline -->
        ...
        <div class="span4">
            ...
            <p class="lead">Partager une expérience de vie, une anecdote,
    ...
    <div class="row"><!-- Begin Bottom Section -->
    	...
    	<div class="span6">
            ...
            <h5 class="title-bg">Partage à la Une ! 
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    ...
                    <div class="post-info clearfix">
                        <h4><a href="blog-single.htm">Titre du partage</a></h4>
        ...
        <div class="span6">
            ...
            <h5 class="title-bg">L'équipe Part Âge : 
                <small>De WebForce3</small>
            ...
            <div class="carousel-inner">
                ...
                <div class="item">
                    <p class="quote-text">"Mauris eget tellus sem. Cras sollicitudin sem eu elit aliquam quis condimentum nulla suscipit. Nam sed magna ante. Ut eget suscipit mauris."<cite>- Séverine, Arnaud, Pier-Elie et François</cite></p>
                </div>
